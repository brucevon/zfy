/**
 * 最近发布数据生成 (Backend Script)
 *
 * 查询 #article=true 且创建时间最新且有内容的笔记。
 *
 * 标签:
 *   saveNoteId = <目标笔记ID>  (必需，需设置 #shareRaw #shareAlias=blog-article)
    ...
    try {
        ...
        if (noteIds.length > 0) {
            ...
            try {
                ...
                console.error("article 图标查询失败: " + e.message);
            }
        }
        ...
        console.error("article 查询失败: " + e.message);
    }
